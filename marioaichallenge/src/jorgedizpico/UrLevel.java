...
public class UrLevel extends Level implements LevelInterface {
    ...
    public UrLevel(int width, int height, long seed, int difficulty,
    ...
    private UrLevel(int width, int height, int difficulty,
            				int type, GamePlay playerMetrics) {
    	// for cloning
		super(width, height);
		this.playerM = playerMetrics;
    ...
    public UrLevel clone() throws CloneNotSupportedException {

    	UrLevel clone = new UrLevel(width, height, difficulty, type, playerM);
