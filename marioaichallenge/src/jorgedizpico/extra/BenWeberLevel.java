 ...
 * 
 */
public class BenWeberLevel extends Level implements LevelInterface {
      ...
      */
     public BenWeberLevel(int width, int height, long seed, int difficulty, int type, GamePlay playerMetrics) {
    	super(width, height);
