...
public class Parser
{
  ...
  static public void main(String[] args)
  {
    ...
    if (ok)
    {
      ...
      arguments.setProperty("Rule", "schematics");
         ...
         ParserException
  {
    ...
    Rule rule = null;
    if (rulename.equalsIgnoreCase("schematics")) rule = Rule$schematics.parse(context);
    else if (rulename.equalsIgnoreCase("transitions")) rule = Rule$transitions.parse(context);
    else if (rulename.equalsIgnoreCase("options")) rule = Rule$options.parse(context);
    else if (rulename.equalsIgnoreCase("concatenation")) rule = Rule$concatenation.parse(context);
    else if (rulename.equalsIgnoreCase("element")) rule = Rule$element.parse(context);
    else if (rulename.equalsIgnoreCase("nonterminal")) rule = Rule$nonterminal.parse(context);
    else if (rulename.equalsIgnoreCase("terminal")) rule = Rule$terminal.parse(context);
    else if (rulename.equalsIgnoreCase("weight")) rule = Rule$weight.parse(context);
    else if (rulename.equalsIgnoreCase("c-wsp")) rule = Rule$c_wsp.parse(context);
    else if (rulename.equalsIgnoreCase("c-nl")) rule = Rule$c_nl.parse(context);
    else if (rulename.equalsIgnoreCase("comment")) rule = Rule$comment.parse(context);
    else if (rulename.equalsIgnoreCase("UPCASE")) rule = Rule$UPCASE.parse(context);
    else if (rulename.equalsIgnoreCase("LOWCASE")) rule = Rule$LOWCASE.parse(context);
